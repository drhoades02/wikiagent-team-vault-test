---
created: 2026-06-19T15:04:07.302960+00:00
updated: 2026-06-19T15:04:07.302960+00:00
concepts:
- BOM
- CRVR
- Gen. 2.5
...
- Sonus
- SPIP7-8
title: 'Verizon Process 101: Low-Level Design Review (SPIP7-8) transcript'
indexes:
- '[[Verizon Migration Procedures]]'
- '[[Verizon Migration Process]]'
- '[[Verizon Process 101]]'
description: Transcript of a Verizon Process 101 low-level design review session for SPIP7-8, focused on locating and interpreting current LLDs, Gen 2.7/legacy design differences, VSN traffic flows, routing instances, VLANs, firewall behavior, and I spec implications for migration preparation.
...
<!-- wikiagent:source-metadata
{
  ...
  "captureKind": "file",
  "capturedAt": "2026-06-19T15:04:07.302960+00:00",
  "conversion": {
    ...
    "detail": {
      ...
      "outputPath": "/Users/drhoades/WikiAgentVault/.wikiagent/cache/docling/verizon-process-101-low-level-design-review-spip7-1781881447638582000.md",
      "status": "succeeded"
    },
    "required": true,
    "status": "succeeded"
  ...
  "email": null,
  "fetchedPage": null,
  "importedAt": "2026-06-19T15:04:07.302960+00:00",
...
Transcript of a Verizon Process 101 training session on low-level design review for SPIP7-8/VSN migration work, covering where to find current LLDs, how Gen 2.5/2.7 and legacy designs differ, how to interpret Broadsoft/SPIP traffic flows, routing instances, VLANs, firewall placement, I spec/BOM implications, and recurring pitfalls in reading heavily revised design documents.
...
Asleep 7.
Where is Germany here? Is there any way I can get to Germany here?
...
And and these LEDs, LLDs, they do.
I think they've lately taken to.
Making them piece meal. Um.
...
**Erickson, James** 6:56
So.
Anything that says micronode is an MX104, we probably won't be doing anything with those. Pip Bridge and is an MX104 with EX44 hundreds probably won't have any more of those to do.
Erickson Engine only had three sites, so we won't be doing any of those. Well, actually we do have two more sites of those we have to migrate early next year and then one gig signaling was.
MX104 with um.
EX44 hundreds in a virtual chassis. So yeah, you're pretty much only looking at.
...
**Don Nguyen** 7:51
27.
27 is the MX 96 with the latest Uh Uh line call, right?
...
**Don Nguyen** 12:53
Why do they call Erickson engine to connect to a Nokia Siemen router or something on the other side? What do they call Erickson engine? I'm just curious.

<!-- image -->

**Erickson, James** 13:04
Yeah, it's an Erickson brand. Um.
Uh.
...
I'm trying to the the core routing and uh platforms in the Erickson engine site was um.
...
**Don Nguyen** 15:18
Got it. So OK, so Eric and engine basically before is a Cisco 7613. Is that what the the the the the slang come from Eric and engine?

<!-- image -->

**Erickson, James** 15:19
Um.
Yeah, well, no, the Erickson engine is actually part of this. The service is provided beyond the route core, the the routing platforms, the Ciscos were kind of routing aggregators or.
...
Aggregate aggregating routers. Sometimes they refer to them as a R routers. That's what you'll see that in the lab in the Eric's engine. They're named a Rs.
...
**Don Nguyen** 16:31
Crap, because Sonas is a company right across the street from the 12/1 headquarter. I mean right across the street.
...
**Czirjak, Gery** 16:40
Well, you'll hear the name Ribbon a lot, right? And Ribbon 8 Sonus, I believe, and they use a lot of Ribbon stuff.
...
**Don Nguyen** 17:00
Oh yeah, yeah.
And I know Acme Packett and Brasov is out of Colorado or somewhere Denver.
...
Yeah, it's a little bit not as fat as AG Bic, but fatter than a SFP.
...
So.
Yeah, and that goes, that's it's totally a thing. And they still have gbix in production too, so.
...
**Don Nguyen** 23:19
You mean the AE100AE0? Those are not in LOD.
...
My gosh, he's got comments back to 2020 on here and it's impossible to read. And this isn't the first time anybody will say that these LODs are impossible to read. This is why we're kind of having this call is to.
Making you aware that these will be challenging. You know, even working with these LDS is going to be challenging because.
They.
...
Um, SPCS. I'm not sure about the D skip, but that's what the LDLD is for. We'll find out.
...
Virtual service note.

<!-- image -->

**Kanumuru, Mohan** 28:29
Which will service node?
...
Um, the only I think.
You'll have to verify it with the with the correct LLD though, right? That's one of the reason these LDS exist, because it'll tell you, for example, that you know Broadsoft or SPIP.
And.
...
**Don Nguyen** 32:56
Yeah, I know. I saw him in Lou. I'm not sure he's a Verizon person or a Jumper. I I went to dinner with him my first week at work.
...
**Czirjak, Gery** 39:55
I think the 6.1 LLD is a little newer than this one names.
...
**Czirjak, Gery** 41:06
Yeah, if you look under the Gin 27 DPC uplift, James, you'll find it buried in there.
...
Um V lands. We only we have just the 2021 going up to your Vas. Um.
...
So.
All site traffic between a pair of AS is hosted between 2G diverse super nuzzle route over the public IPVPN VIV so.
...
A S701 that MPLS network. It has a default routing table and a a VPN routing table. The VPN routing table you know being just for VoIP infrastructure VPN.
Right, that's what Viv means, but a lot of times that default routing table is referred to as the public IP. The difference, the only discriminating factor to tell which is which.
...
**Don Nguyen** 49:40
Excel. Is that the same notation of VA?

<!-- image -->

**Erickson, James** 49:43
Yeah, because Excels were the a previous generation of um the Vas.
...
Only certain VAP NS might use that NAT or I'm sorry VSNS. This is specifically Broadsoft. Broadsoft might use IP addresses that are public IP.
...
Can we scale about the time? I'm just kidding. Yeah, it's it's like peeling a damn onion, like in the Sweat movie, man.
...
**Don Nguyen** 58:26
The RIP group export import, yeah.

<!-- image -->

**Erickson, James** 58:27
The RIB groups, yeah, they're specific to the Broadsoft.
Um, you won't see the re rib groups with anything but the broad soft. Um.
...
Yeah, at any rate, um.
It's in the L&amp;D, so you'll add it. Um.
...
<!-- wikiagent:alias-remap
{
  ...
  "substitutions": [
    {
      "appliedAt": "2026-06-19T15:12:44.265109+00:00",
      "canonicalTerm": "SPIP7-8",
      "reviewCardId": 253,
      "term": "S pip seven and eight"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.341063+00:00",
      "canonicalTerm": "SPIP7-8",
      "reviewCardId": 254,
      "term": "SP 7-8"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.403890+00:00",
      "canonicalTerm": "VSN",
      "reviewCardId": 255,
      "term": "VSNS"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.466766+00:00",
      "canonicalTerm": "Virtual service node",
      "reviewCardId": 256,
      "term": "Virtual service note"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.526287+00:00",
      "canonicalTerm": "VA router",
      "reviewCardId": 257,
      "term": "XL router"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.583988+00:00",
      "canonicalTerm": "XL router",
      "reviewCardId": 258,
      "term": "Excel router"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.645785+00:00",
      "canonicalTerm": "VoIP infrastructure VPN",
      "reviewCardId": 259,
      "term": "VIV"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.709814+00:00",
      "canonicalTerm": "VoIP infrastructure VPN",
      "reviewCardId": 260,
      "term": "Public IP VPN"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.768022+00:00",
      "canonicalTerm": "Ericsson Engine",
      "reviewCardId": 261,
      "term": "Eric and engine"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.826186+00:00",
      "canonicalTerm": "Sonus",
      "reviewCardId": 262,
      "term": "Sonas"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.884993+00:00",
      "canonicalTerm": "LLD",
      "reviewCardId": 263,
      "term": "LDLD"
    },
    {
      "appliedAt": "2026-06-19T15:12:44.943867+00:00",
      "canonicalTerm": "LLD",
      "reviewCardId": 264,
      "term": "LOD"
    },
    {
      "appliedAt": "2026-06-19T15:12:45.119050+00:00",
      "canonicalTerm": "SPIP7-8",
      "reviewCardId": 275,
      "term": "SPIP 7/8"
    },
    {
      "appliedAt": "2026-06-19T15:12:45.119322+00:00",
      "canonicalTerm": "SPIP7-8",
      "reviewCardId": 275,
      "term": "SPIP 7 and eight"
    },
    {
      "appliedAt": "2026-06-19T15:12:45.180862+00:00",
      "canonicalTerm": "LLD",
      "reviewCardId": 276,
      "term": "Low Level Design"
    },
    {
      "appliedAt": "2026-06-19T15:12:45.181165+00:00",
      "canonicalTerm": "LLD",
      "reviewCardId": 276,
      "term": "Low Level Design Review"
    },
    {
      "appliedAt": "2026-06-19T15:12:45.181457+00:00",
      "canonicalTerm": "LLD",
      "reviewCardId": 276,
      "term": "LLDs"
    }

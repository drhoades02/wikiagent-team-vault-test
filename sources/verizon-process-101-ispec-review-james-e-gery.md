---
created: 2025-12-02T20:33:00
updated: 2026-06-19T15:11:33.191800+00:00
concepts:
- CCR
- cut sheets
- D1 and D2
...
- Rob Lebue
- Scott Stroud
title: 'Verizon Process 101: ISPEC Review'
indexes:
- '[[Team Index]]'
...
subIndexes:
- '[[ISPEC Review]]'
description: Transcript of a Verizon Process 101 ISPEC review training session covering PRF/CCR/NFID inputs, master port assignments, D1/D2 telemetry, SFP checks, and old-to-new router port reconciliation for Verizon migrations.
---
<!-- wikiagent:source-metadata
{
  "agentExtractionStatus": "pending",
  "captureKind": "file",
  "capturedAt": "2026-06-19T15:03:58.893428+00:00",
  "conversion": {
    ...
    "detail": {
      ...
      "outputPath": "/Users/drhoades/WikiAgentVault/.wikiagent/cache/docling/verizon-process-101-ispec-review-james-e-gery-1781881439035378000.md",
      "status": "succeeded"
    },
    "required": true,
    "status": "succeeded"
  ...
  "email": null,
  "fetchedPage": null,
  "importedAt": "2026-06-19T15:03:58.893428+00:00",
...
Transcript of a Verizon Process 101 training session on ISPEC review, covering how PRF/CCR/NFID engineering inputs, master port allocations, D1/D2 telemetry, I-spec tabs, SFP validation, packet broker/flex tap connections, and old-to-new router port reconciliation are used to catch migration discrepancies before installation and maintenance-window work.
...
Um.
So the I spec.
Installation specifications. We last time we talked about the.
Um LLDS.
And.
...
So let's see.
Let's see, where were those stored at? Does anyone remember where these PRFs?
What are they?
...
So that's where we would want this flagged even before it gets to this this I specs base stage you you catch it in the PRF. Ideally you know we haven't really been able to catch it that early.
...
Um.
Brad Rubio or any of these other DE representatives. They're the ones responsible for taking the engineering information from the PRS.
Um that that CCR um.
...
CCR Yeah, they're taking these these CCRs, you know, and creating an I spec. These have everything in them. There should have everything.
But that's part of our job. This is why one of the reasons we're having this call is if we didn't catch it in the PRF or on the master.
Port allocation. Um, and it's not here in the PRS. Um, or we didn't catch it there, then we need to go.
...
So you just put the CCR number and FID.
...
You can't open these in Citrix. We don't have Excels and it's worthless on Google O.
...
The spec itself.
Um.
The I spec itself, you know one of the first things I always look at is to just make sure they have D1 and D2 cause you're not getting anywhere with the layer one.
Uh.
...
And.
You know, I think a few of you have seen a migration, you know and have seen where they have to jumble these around. They they went through and made changed their base assignments there on the packet brokers on these 50 tens.
Um.
They so sometimes that is not a service affecting thing. Then cat usually directs that. That's not our gear, but.
you know it's something to watch out for, just so you don't, and um just so you're aware of it when you're reviewing the ice specs, trying to make heads or tails over what's connected where
Um.
And.
Uh, yeah, so.
...
So many times around that circle, through that loop, trying to tie out these numbers here for orders in the 1st place, and then you don't think about it until six months later when you see the ice back.

<!-- image -->

**Reddy, Resha** 48:11
Yeah, because things change, right? You, you do a FOA and then you realize that there's an issue and then you order and then you know you have to go back and make sure that they've actually made the updates to the additional, the additional sites for the ice specs and the CCRS. So you have to make sure that when you get the ice spec, you validate against.
...
So if you do need track down SFPs or or a a specific card or something, this is where you're gonna find the PO number for it.
Uh, then there's um.
An overall summary material with the justice the quantities.
...
From base chassis all the way up to SFP. So base chassis, MPC, Nick port.
And the F assigned to it.
Um.
...
Bricks.
These.
Should have only ideally management for these new bricks is all run to IDN. Occasionally you'll see them the manage market management port connected to the MX960.
...
Um.
And.
For tap, are we talking the flex taps here or what were these?
What were these referencing?

<!-- image -->

**Czirjak, Gery** 1:09:16
Oh, I don't remember. These are the taps going to the public IP right 'cause they have 410 gig links now on the 40 gig node.
...
I guess for what it's worth, guys, the one you probably heard this from James a few Times Now. The problem with doing the I spec reviews is there's a lot of variations and it's very unclear what should or shouldn't be there.
...
**Don Nguyen** 1:11:48
It's all the cable label correctly. I mean, I don't know what is. Are they the cable pre pre-made, pre-label and they DE approved or just like I've been nearly Willy stuff?
...
Or this one will be represented as 0/0. This one is commonly referred to as M3, and that one's commonly referred to as one and one. So this might be what you see in a description on the.
Existing routers.
Um.
...
**Don Nguyen** 1:14:15
So the Verizon team, they they design, they they they build a cable runless and give it to a remote hand to wire the stuff. We only concerned about the MX connectivity only, right? The rest we assume they are correct, right?
...
<!-- wikiagent:alias-remap
{
  ...
  "substitutions": [
    {
      "appliedAt": "2026-06-19T15:11:40.781914+00:00",
      "canonicalTerm": "SFP",
      "reviewCardId": 283,
      "term": "SF PS"
    },
    {
      "appliedAt": "2026-06-19T15:11:40.857980+00:00",
      "canonicalTerm": "SFP",
      "reviewCardId": 284,
      "term": "Sfps"
    },
    {
      "appliedAt": "2026-06-19T15:11:40.916489+00:00",
      "canonicalTerm": "Venue",
      "reviewCardId": 285,
      "term": "Athenia"
    },
    {
      "appliedAt": "2026-06-19T15:11:41.080573+00:00",
      "canonicalTerm": "Rob Lebue",
      "reviewCardId": 296,
      "term": "Rob Lebou"
    },
    {
      "appliedAt": "2026-06-19T15:11:41.080706+00:00",
      "canonicalTerm": "Rob Lebue",
      "reviewCardId": 296,
      "term": "Rob Le Bue"
    },
    {
      "appliedAt": "2026-06-19T15:11:41.080826+00:00",
      "canonicalTerm": "Rob Lebue",
      "reviewCardId": 296,
      "term": "Rob Labue"
    },
    {
      "appliedAt": "2026-06-19T15:11:41.136310+00:00",
      "canonicalTerm": "SFP",
      "reviewCardId": 297,
      "term": "SFPS"
    },
    {
      "appliedAt": "2026-06-19T15:11:41.136634+00:00",
      "canonicalTerm": "SFP",
      "reviewCardId": 297,
      "term": "SFP's"
    }

---
created: 2026-06-17T02:51:32.679712+00:00
updated: 2026-06-17T02:55:30.943155+00:00
concepts:
- BGP sessions
- go/no-go call
- maintenance window
...
- pre-checks
- SPIP
- Verizon Process 101 MW process
- VRRP
entities:
- Erickson, James
- JTAC proactive case
...
- December 17, 2025
- rollback decisions
title: 'Verizon Process 101: Maintenance-window pre-checks, migration, and post-checks'
indexes:
- '[[Team Index]]'
- '[[Verizon Process 101]]'
description: Transcript of a Verizon Process 101 training session on maintenance-window pre-checks, migration tasks, Kirk handling, monitoring, rollback timing, post-checks, and handoff.
...
<!-- wikiagent:source-metadata
{
  ...
  "captureKind": "file",
  "capturedAt": "2026-06-17T02:51:32.679712+00:00",
  "conversion": {
    ...
    "detail": {
      ...
      "outputPath": "/Users/drhoades/WikiAgentVault/.wikiagent/cache/docling/verizon-process-101-mw-process-prechecks-migration-and-1781664692695161000.md",
      "status": "succeeded"
    },
    "required": true,
    "status": "succeeded"
  ...
  "email": null,
  "fetchedPage": null,
  "importedAt": "2026-06-17T02:51:32.679712+00:00",
...
Training transcript for a Verizon maintenance-window migration process covering Kirk task approval/opening, pre-checks, health baselines, S2I monitoring, SSH/Junos logging, rollback timing, JTAC proactive cases, post-checks, and closing communications.
...
Every SPIP pip or SPIP site has probably at least 100 customers provisioned in there and trying to error correct for all 100 of those before we even start a migration.
...
If at all better they could to one recommendation you know if as Racer or TJ or Mike are listening to this recording is to put these in a text format.
...
Worked.
Who did the health checks? For example, James Rader did health checks on the equipment previously. Teresa for the bricks. Paul did the Geo probe pre-check.
...
Don't.
Manage our time right and go over our window. JTAC every maintenance as showing you this.
No wrong.
...
<!-- wikiagent:alias-remap
{
  ...
  "substitutions": [
    {
      "appliedAt": "2026-06-17T03:07:17.268934+00:00",
      "canonicalTerm": "VRRP",
      "reviewCardId": 7,
      "term": "VRP"
    },
    {
      "appliedAt": "2026-06-17T03:07:18.667815+00:00",
      "canonicalTerm": "JTAC",
      "reviewCardId": 8,
      "term": "J tech"
    },
    {
      "appliedAt": "2026-06-17T03:07:20.178847+00:00",
      "canonicalTerm": "S2I",
      "reviewCardId": 9,
      "term": "S to I"
    },
    {
      "appliedAt": "2026-06-17T03:07:30.684361+00:00",
      "canonicalTerm": "S2I",
      "reviewCardId": 16,
      "term": "SS2"
    },
    {
      "appliedAt": "2026-06-17T03:07:31.819870+00:00",
      "canonicalTerm": "go/no-go call",
      "reviewCardId": 17,
      "term": "go no go call"
    },
    {
      "appliedAt": "2026-06-17T03:07:31.820099+00:00",
      "canonicalTerm": "go/no-go call",
      "reviewCardId": 17,
      "term": "go, no go call"
    },
    {
      "appliedAt": "2026-06-17T03:07:31.820315+00:00",
      "canonicalTerm": "go/no-go call",
      "reviewCardId": 17,

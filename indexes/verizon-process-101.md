...
- [[sources/verizon-process-101-mw-process-prechecks-migration-and|verizon process 101 mw process prechecks migration and]]: Verizon maintenance-window migrations require approved Kirk requests, pre-check health baselines, S2I and Junos monitoring, logged SSH sessions, rollback timing decisions, JTAC readiness, and post-check handoff.
